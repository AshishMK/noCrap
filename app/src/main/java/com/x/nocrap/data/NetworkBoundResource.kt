...
protected constructor() {
        ...
        if (shouldFetch()) {
            ...
            source = createCall()
                ...
                .onErrorResumeNext { t: Throwable ->
                    loadFromDb(null).toObservable().map {
    ...
    @MainThread
    protected abstract fun loadFromDb(item: Resource<RequestType>?): Flowable<ResultType>
