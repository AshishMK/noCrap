package com.x.nocrap.di.appComponent

import android.app.Application
import com.x.nocrap.application.AppController
import com.x.nocrap.di.module.*
 ...
 * */
@Component(modules = [FragmentModule::class, ApiModule::class, ExoPlayerModule::class, ActivityModule::class, ViewModelModule::class, AndroidSupportInjectionModule::class])
@Singleton
